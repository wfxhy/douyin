 ...
 * @date 2022-02-28
 */
public interface MerResourceMapper 
{
    /**
     * 查询商户资源
     * 
     ...
     * @return
     */
    public MerResource getRandMerReource(@Param("merchantId") Long merchantId, @Param("groupId") Long groupId, @Param("activityId") Long activityId);
}
