...
import com.toker.project.system.service.ISysPostService;
...
public class MerchantsUserController extends BaseController
{
     ...
     * 获取用户列表
     */
    @PreAuthorize("@ss.hasPermi('merchants:user:list')")
    @GetMapping("/list")
    ...
    @PreAuthorize("@ss.hasPermi('merchants:user:export')")
    @PostMapping("/export")
    ...
    @PreAuthorize("@ss.hasPermi('merchants:user:import')")
     ...
     * 根据用户编号获取详细信息
     */
    @PreAuthorize("@ss.hasPermi('merchants:user:query')")
     ...
     * 新增用户
     */
    @PreAuthorize("@ss.hasPermi('merchants:user:add')")
     ...
     * 修改用户
     */
    @PreAuthorize("@ss.hasPermi('merchants:user:edit')")
     ...
     * 删除用户
     */
    @PreAuthorize("@ss.hasPermi('merchants:user:remove')")
     ...
     * 重置密码
     */
    @PreAuthorize("@ss.hasPermi('merchants:user:resetPwd')")
    @Log(title = "用户管理", businessType = BusinessType.UPDATE)
    @PutMapping("/resetPwd")
